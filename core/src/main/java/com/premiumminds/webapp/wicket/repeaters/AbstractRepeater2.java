 ...
 */
abstract class AbstractRepeater2 extends WebMarkupContainer
{
	private static final long serialVersionUID = 1L;

	private static final Logger log = LoggerFactory.getLogger(AbstractRepeater2.class);
	 ...
	 * @param id
	 */
	public AbstractRepeater2(String id)
	{
		super(id);
	}
	 ...
	 * @param model
	 */
	public AbstractRepeater2(String id, IModel<?> model)
	{
		super(id, model);
	}
